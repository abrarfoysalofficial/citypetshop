  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-slate-600">
        Invoices for your orders. Download PDF from each row (mock link).
      </p>
      {invoices.length === 0 ? (
            ...
            <tbody>
              {invoices.map((inv) => (
                <tr key={inv.id} className="border-b border-slate-100">
                  ...
                  <td className="p-3">
                    <a href={inv.downloadUrl ?? "#"} className="font-medium text-primary hover:underline">Download PDF (mock)</a>
                  </td>
                </tr>
              ))}
            </tbody>
