...
export async function GET() {
  ...
  const data = await prisma.homeBottomBanner.findMany({
...
export async function POST(request: NextRequest) {
  ...
  const data = await prisma.homeBottomBanner.create({
    data: {
...
export async function PATCH(request: NextRequest) {
  ...
  const data = await prisma.homeBottomBanner.update({
    where: { id },
    data: {
...
export async function DELETE(request: NextRequest) {
  ...
  await prisma.homeBottomBanner.delete({ where: { id } });
