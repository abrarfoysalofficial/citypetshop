...
export async function GET() {
  ...
  const data = await prisma.homeSideBanner.findMany({
...
export async function POST(request: NextRequest) {
  ...
  const data = await prisma.homeSideBanner.create({
    data: {
...
export async function PATCH(request: NextRequest) {
  ...
  const data = await prisma.homeSideBanner.update({
    where: { id },
    data: {
...
export async function DELETE(request: NextRequest) {
  ...
  await prisma.homeSideBanner.delete({ where: { id } });
