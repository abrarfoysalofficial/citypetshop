...
const TOP_SELLERS = [
  { id: "1", name: "Premium Dog Food 10kg", image: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400", price: 2890, comparePrice: 3200, slug: "premium-dog-food" },
  { id: "2", name: "Cat Wet Food Pack", image: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=400", price: 550, comparePrice: 650, slug: "cat-wet-food" },
  { id: "3", name: "Bird Seed Mix 1kg", image: "https://images.unsplash.com/photo-1450778869180-41d0601e046e?w=400", price: 350, comparePrice: 400, slug: "bird-seed" },
];

export default function TopSellerCard() {
  const [index, setIndex] = useState(0);
  const { addItem, openCart } = useCart();
  const item = TOP_SELLERS[index % TOP_SELLERS.length];
    ...
    <div className="w-full shrink-0 rounded-xl border-2 border-slate-200 bg-white p-4 shadow-sm lg:w-72">
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="flex gap-1">
          <button
            type="button"
            onClick={() => setIndex((i) => (i - 1 + TOP_SELLERS.length) % TOP_SELLERS.length)}
          ...
          <button
            type="button"
            onClick={() => setIndex((i) => (i + 1) % TOP_SELLERS.length)}
            className="rounded-lg p-1.5 text-slate-500 hover:bg-slate-100"
            aria-label="Next"
          >
