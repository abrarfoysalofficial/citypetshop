...
<section><h2>১১. যোগাযোগ ও সাপোর্ট</h2><p>সেবার শর্তাবলী সংক্রান্ত প্রশ্নের জন্য যোগাযোগ করুন: <a href="mailto:${CONTACT_EMAIL}" class="text-primary hover:underline">${CONTACT_EMAIL}</a> অথবা ফোন <a href="tel:+8801643390045" class="text-primary hover:underline">+৮৮০ ১৬৪৩-৩৯০০৪৫</a>। ঠিকানা: মিরপুর ২, বড়বাগ, ঢাকা, বাংলাদেশ।</p></section>`,
        },
        privacy: {
...
<section><h2>১১. যোগাযোগ</h2><p>এই গোপনীয়তা নীতি সম্পর্কে প্রশ্নের জন্য যোগাযোগ করুন: <a href="mailto:${CONTACT_EMAIL}" class="text-primary hover:underline">${CONTACT_EMAIL}</a> অথবা ফোন <a href="tel:+8801643390045" class="text-primary hover:underline">+৮৮০ ১৬৪৩-৩৯০০৪৫</a>। ঠিকানা: মিরপুর ২, বড়বাগ, ঢাকা, বাংলাদেশ।</p></section>`,
        },
        refund: {
...
<section><h2>৩. ভুল/ক্ষতিগ্রস্ত পণ্য প্রক্রিয়া</h2><p>ভুল বা ক্ষতিগ্রস্ত পণ্য দাবি করতে হলে: (ক) আনবক্সিং ভিডিও বা ফটো প্রমাণ রাখুন, (খ) পণ্য ও প্যাকেজিংয়ের স্পষ্ট ছবি পাঠান, (গ) অর্ডার আইডি ও সমস্যার বিবরণ দিয়ে <a href="mailto:${CONTACT_EMAIL}" class="text-primary hover:underline">${CONTACT_EMAIL}</a> বা ফোন <a href="tel:+8801643390045" class="text-primary hover:underline">+৮৮০ ১৬৪৩-৩৯০০৪৫</a> এ যোগাযোগ করুন। আমরা ২৪–৪৮ ঘণ্টার মধ্যে সাড়া দেব এবং প্রক্রিয়া জানাব।</p></section>
...
<section><h2>৮. যোগাযোগ ও সাপোর্ট</h2><p>রিটার্ন/রিফান্ড সম্পর্কে প্রশ্নের জন্য যোগাযোগ করুন: <a href="mailto:${CONTACT_EMAIL}" class="text-primary hover:underline">${CONTACT_EMAIL}</a> অথবা ফোন <a href="tel:+8801643390045" class="text-primary hover:underline">+৮৮০ ১৬৪৩-৩৯০০৪৫</a>। ঠিকানা: মিরপুর ২, বড়বাগ, ঢাকা, বাংলাদেশ। অর্ডার আইডি ও সমস্যার বিবরণ দিয়ে যোগাযোগ করলে দ্রুত সহায়তা পাবেন।</p></section>`,
        },
      };
